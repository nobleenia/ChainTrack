            ...
            <div className="flex gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 text-lg border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 font-mono placeholder-gray-400 dark:placeholder-gray-500"
                />
              </div>
              <Button
                type="submit"
        ...
        <AnimatePresence>
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -10 }}
              className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-xl p-4 mb-6 flex items-start gap-3"
            >
              <ShieldX className="text-red-500 dark:text-red-400 flex-shrink-0" size={24} />
              <div>
                <h3 className="font-medium text-red-800 dark:text-red-300">Verification Failed</h3>
            ...
            >
              ...
              <div className={`rounded-xl p-6 flex items-center gap-4 ${
                ...
                <div>
                  <h2 className={`text-xl font-bold ${
                    result.verified ? 'text-green-800 dark:text-green-300' : 'text-yellow-800 dark:text-yellow-300'
                  }`}>
                    {result.verified ? 'Authentic Product' : 'Verification Pending'}
                  </h2>
                  <p className={`text-sm ${
                    result.verified ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400'
                  }`}>
                    {result.verified 
              ...
              {pointsEarned && (
                <motion.div
                  ...
                  className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/30 dark:to-indigo-900/30 border border-purple-200 dark:border-purple-700 rounded-xl p-4 flex items-center justify-between"
                >
              ...
              {!isAuthenticated && result.access_level === 'basic' && (
                <motion.div
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/30 dark:to-cyan-900/30 border border-blue-200 dark:border-blue-700 rounded-xl p-4"
                >
                ...
                <div className="p-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-white text-lg">{result.product?.name}</p>
                    </div>
                    <div>
                      <span className="text-sm text-gray-500 dark:text-gray-400">Product ID</span>
                      <p className="font-mono text-gray-900 dark:text-gray-100">{result.product?.product_id}</p>
                    </div>
                    <div>
                  ...
                  {result.product?.description && (
                    <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
                      ...
                      <p className="text-gray-700 dark:text-gray-300 mt-1">{result.product?.description}</p>
                    </div>
                  )}
                </div>
              </div>
                  ...
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="font-medium text-gray-900 dark:text-white">{result.blockchain?.network || 'Ethereum Sepolia'}</p>
                      </div>
                      <div>
                      ...
                      {result.blockchain?.hash && (
                        <div className="md:col-span-2">
                          ...
                          <p className="font-mono text-sm text-gray-900 dark:text-gray-100 break-all bg-gray-50 dark:bg-gray-700 p-2 rounded mt-1">
                            {result.blockchain.hash}
                          </p>
                        </div>
                      )}
                        ...
                        >
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            {index < result.journey.length - 1 && (
                              <div className="w-0.5 h-full bg-gray-200 dark:bg-gray-600 my-1" />
                            )}
                          </div>
